      ...
      <Reveal className="mx-auto flex max-w-2xl flex-col items-center gap-6 text-center">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-3">
          <a
            ...
            className="focus-ring group inline-flex h-12 items-center gap-2 rounded-[4px] bg-accent px-5 text-sm font-semibold text-on-accent active:scale-[0.98]"
          >
          ...
          <a
            ...
            className="focus-ring inline-flex h-12 items-center gap-2 rounded-[4px] border border-line px-5 text-sm font-semibold transition-colors hover:bg-background active:scale-[0.98]"
          >
