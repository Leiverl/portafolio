...
const es = {
  ...
  about: {
    ...
    body2: "Trabajo con el ecosistema TypeScript de punta a punta: NestJS en el backend, Next.js y React en la web, Expo en el móvil y PostgreSQL como columna vertebral. También me acoplo fácil a cualquier equipo o stack: si el proyecto requiere otra tecnología, proceso o herramienta, la aprendo y la asumo sin fricción.",
    highlights: [
...
const en: typeof es = {
  ...
  about: {
    ...
    body2: "I work across the whole TypeScript ecosystem: NestJS on the backend, Next.js and React on the web, Expo on mobile and PostgreSQL as the backbone. I also adapt easily to any team or stack: if the project needs another technology, process or tool, I learn it and take it on without friction.",
    highlights: [
